...
class Bomber:
    ...
    def pochtabank(self):
        while self.phone in phones_in_spam:
            try:
                print("VANDALIZM ----- запрос на SMS отправлен успешно")
                ...
                print("VANDALIZM ----- запрос на SMS не отправлен ")
                pass
            sleep(25)
...
def main():
    ...
    print(f'\n\nЗдравствуй наш дорогой друг.\nНаш VK:  https://vk.com/dnk_dark_net_committee \nчто бы выбрать как начать спам нажми "1"  \n[1] Меню \n')
    task = input('')
    if task.isdigit():
        if task == '1':
            ...
            if task.isdigit():
                if task == '3':
                    ...
                    print(banner)
                    print('ВНИМАНИЕ! Данный бомбер работает только на номера РФ!\n')
                    ...
                    if phone == '0':
                        ...
                        print(f'Спам атака на номер {phone} начат.')
...
if __name__ == '__main__':
    main()
#и вот ты добрался до конца кода, а зачем ?
# ведь ты тупой жирный вася из 5ь)))))))
# я прав?)))))))))))